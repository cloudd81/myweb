...
public String paging4(int totalRecord, int nowPage, int recordPerPage, String col, String word, String filenm){
  ...
  if (nowGrp >= 2){
    ...
    str.append("<li class=\"previous\"><A href='./"+filenm+"?col="+col+"&word="+word+"&nowPage="+_nowPage+"'>이전</A></li>");
    str.append("</ul>");
  }
  ...
  for(int i=startPage; i<=endPage; i++){
    ...
    if (nowPage == i){
      ...
      str.append(" <li><a class='pagenum' href='./"+filenm+"?col="+col+"&word="+word+"&nowPage="+i+"'>"+i+"</a></li>");  
    }
    str.append("</ul>");
  }
  ...
  if (nowGrp < totalGrp){
	  str.append("<ul class=\"pager\">");
	    str.append("<li class=\"next\"><A href='./"+filenm+"?col="+col+"&word="+word+"&nowPage="+_nowPage+"'>다음</A></li>");
	    str.append("</ul>");
  }
  str.append("</DIV>");
